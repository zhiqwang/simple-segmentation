...
from models.segmentation import fcn_resnet50
...
def get_dataset(name, image_set, transform):
    ...
    paths = {
        ...
        "coco": ('./data-bin/pupil_fd/', get_coco, 2)
    }
...
def get_transform(train):
    ...
    transforms.append(T.Normalize(mean=[0.243, 0.243, 0.243],
                                  std=[0.129, 0.129, 0.129]))
